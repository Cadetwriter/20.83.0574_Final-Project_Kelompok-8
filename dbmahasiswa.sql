...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2022 at 01:36 AM
...
--
-- Table structure for table `biodata mahasiswa`
--

CREATE TABLE `biodata mahasiswa` (
  `No` varchar(200) NOT NULL,
  `NIM` varchar(200) NOT NULL,
  `Nama` text NOT NULL,
  `JK` char(200) NOT NULL,
  `Jurusan` text NOT NULL,
  `Alamat` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `biodata mahasiswa`
--

INSERT INTO `biodata mahasiswa` (`No`, `NIM`, `Nama`, `JK`, `Jurusan`, `Alamat`) VALUES
